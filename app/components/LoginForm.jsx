...
export default function LoginForm() {
  const handleSubmit = async (e) => {
    ...
    // Use the signIn function from NextAuth.js to authenticate the user
    const result = await signIn('credentials', {
      email,
      password,
      redirect: false, // Set to false to handle the redirect yourself
    });
    ...
    if (result.error) {
      ...
      // You can use router.push('/home') for client-side routing
